...
public class CreateLead extends Common {
	...
	public void runCreateLead(String companyName,String firstName,String lastName) {
		...
		driver.findElementById("createLeadForm_importantNote")
				.sendKeys("This field is used to enter the Important Note.");
		...
		driver.findElementById("createLeadForm_generalAddress1").sendKeys("3/42 Moovendhar Street, Thirumalai Nagar",
				Keys.TAB, "Ramapuram");
